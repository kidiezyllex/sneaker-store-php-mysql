...
$featured_products = $featuredStmt->fetchAll();

$bestSellerStmt = $db_conn->query("
    ...
    LIMIT 4
");
$best_sellers = $bestSellerStmt->fetchAll();

$categoryStmt = $db_conn->query("
...
$brandStmt = $db_conn->query("
    ...
    LIMIT 6
");
$top_brands = $brandStmt->fetchAll();

$metricsStmt = $db_conn->query("
    SELECT
                            ...
                            <div class="product-card h-100 product-card--highlight">
                                ...
                                <div class="product-card__body">
                                    ...
                                    <div class="product-card__rating">
                                        <div class="product-card__stars">
                                            <?php 
                                            $rating = rand(40, 50) / 10; // Random rating 4.0 - 5.0 for best sellers
                                            $fullStars = floor($rating);
                                            $hasHalfStar = ($rating - $fullStars) >= 0.5;
                                            for ($i = 0; $i < $fullStars; $i++): ?>
                                                <i class="fas fa-star"></i>
